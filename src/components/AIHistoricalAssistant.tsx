...
const AIHistoricalAssistant = () => {
  ...
  const aiPersona: Persona = {
    ...
    description:
      "AI được huấn luyện chuyên sâu về quan điểm Mác-Lênin và chính sách của Đảng về tôn giáo trong thời kỳ quá độ lên CNXH",
...
Lưu ý mạnh: TUYỆT ĐỐI không trả lời các câu hỏi không liên quan đến nội dung bài học, kể cả khi người dùng yêu cầu hoặc thúc ép.`;
      ...
      const fallbackResponses = {
        "phật giáo":
          "Phật giáo là tôn giáo lớn ở Việt Nam với khoảng 10 triệu tín đồ. Giáo hội Phật giáo Việt Nam được thành lập năm 1981, thống nhất các hệ phái. Phật giáo có truyền thống gắn bó với dân tộc, tham gia nhiều hoạt động từ thiện xã hội và đóng góp vào khối đại đoàn kết dân tộc.",
        "công giáo":
          "Công giáo (Thiên Chúa giáo) có khoảng 7 triệu tín đồ tại Việt Nam. Hội đồng Giám mục Việt Nam thường xuyên đối thoại với Nhà nước. Nhiều linh mục, giáo dân tích cực tham gia các hoạt động xã hội, từ thiện, y tế, giáo dục, và thực hiện phương châm 'sống phúc âm giữa lòng dân tộc'.",
        "cao đài":
          "Đạo Cao Đài là tôn giáo nội sinh ra đời tại Việt Nam năm 1926, kết hợp tinh hoa của nhiều tôn giáo. Hiện có khoảng 2,5 triệu tín đồ, chủ yếu ở Nam Bộ. Cao Đài có truyền thống yêu nước, đồng hành cùng dân tộc trong các thời kỳ lịch sử.",
        "hòa hảo":
          "Phật giáo Hòa Hảo được sáng lập năm 1939 bởi ông Huỳnh Phú Sổ, có khoảng 1,5 triệu tín đồ tập trung ở các tỉnh An Giang, Đồng Tháp, Vĩnh Long. Giáo lý nhấn mạnh tu tại gia, hành thiện, cứu khổ, và có truyền thống yêu nước.",
        "tin lành":
          "Tin Lành du nhập vào Việt Nam từ đầu thế kỷ 20, hiện có khoảng 1,5 triệu tín đồ. Hội thánh Tin Lành Việt Nam (miền Bắc) được công nhận năm 1963, Hội thánh Tin Lành Việt Nam (miền Nam) được công nhận năm 2001. Các mục sư, tín đồ tích cực tham gia các hoạt động xã hội.",
      };
  ...
  if (!isOpen) {
    return (
      <motion.button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-r from-orange-500 to-lime-600 text-white rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 z-50 flex items-center justify-center"
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className={`bg-gradient-to-r ${currentPersona.color} text-white p-4 flex items-center justify-between`}
      >
